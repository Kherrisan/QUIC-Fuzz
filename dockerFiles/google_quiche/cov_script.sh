...
SERVER_CMD="/tmp/google_quiche_cov/bazel-bin/quiche/quic_server --port=4433  --certificate_file=/tmp/google_quiche-cert.pem --key_file=/tmp/google_quiche-key.pem"
