...
# EDIT THESE (those in "")
TARGET_DIR=${TARGET_DIR:-"quicly"}
COVERAGE_DIR=${COVERAGE_DIR:-"quicly_cov"}
INPUTS=${INPUTS:-"${WORKDIR}/quicly_seed"}
SERVER_CMD="/tmp/quicly/cli -c /tmp/server-cert.pem -k /tmp/server-key.pem  127.0.0.1 4433 -B 012345678910"
COV_BIN="/tmp/quicly_cov/cli"
